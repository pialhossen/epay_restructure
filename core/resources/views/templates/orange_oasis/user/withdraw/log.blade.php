                                ...
                                <tbody>
                                    @foreach (@$withdraws as $withdraw)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn--outline-base btn--sm detailBtn" data-withdraw="{{ $withdraw }}" data-date="{{ __(showDateTime($withdraw->created_at)) }}" data-status="{{ $withdraw->statusBadge }}">
