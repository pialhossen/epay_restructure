                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form--control checkUser" value="{{ old('username') }}"
                                                   name="username" required autocomplete="off" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="country" class="form-select form-control form--control select2" required>
