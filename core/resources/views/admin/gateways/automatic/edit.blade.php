...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.gateway.automatic.update', $gateway->code) }}" class="disableSubmission"
                        ...
                        <div class="payment-method-item block-item">
                            ...
                            <div class="gateway-body">
                                <div class="gateway-content ps-0">
                                                ...
                                                @foreach ($gateway->extra as $key => $param)
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <button type="button" class="copyInput input-group-text"
                                                                title="@lang('Copy')"><i
                                                                    class="fas fa-copy"></i></button>
                                                        </div>
                                                        @if ($key == 'cron')
                                                            <small><i class="las la-info-circle"></i>
                                                                @lang('Set the URL to your server\'s cron job to validate the payment.')</small>
                                                        @endif
                                                    </div>
                                                @endforeach
                                            </div>
                                    ...
                                    @endif
                                    <div class="payment-method-body mt-2">
                                        <h4 class="mb-3 payment-method-body-title">@lang('Global Setting for')
                                            {{ __($gateway->name) }}</h4>
                                        <div class="row">
                                        ...
                                        <div class="card border border--primary">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                                                        <input readonly disabled type="number" step="any"
                                                            class="form-control minAmount"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-text"><span
                                                                class="currency_symbol"></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
