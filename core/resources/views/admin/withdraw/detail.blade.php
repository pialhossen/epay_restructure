            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Amount')
                            <span class="fw-bold">{{ showAmount($withdrawal->amount) }} = {{ number_format($withdrawal->final_amount, $withdrawal->method->show_number_after_decimal) }} {{ __($withdrawal->method->cur_sym) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Charge')
                            <span class="fw-bold">
                                {{ number_format($withdrawal->charge, $withdrawal->method->show_number_after_decimal) }}
                                {{ __($withdrawal->method->cur_sym) }}
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('After Charge')
                            <span class="fw-bold">
                                {{ number_format($withdrawal->after_charge, $withdrawal->method->show_number_after_decimal) }}
                                {{ __($withdrawal->method->cur_sym) }}
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Rate')
                            <span class="fw-bold">
                                1 {{ __($withdrawal->method->cur_sym) }} = {{ showAmount($withdrawal->rate) }}
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Payable')
    ...
    <div id="approveModal" class="modal fade">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.withdraw.data.approve') }}" method="POST" class="disableSubmission">
                    @csrf
    ...
    <div id="rejectModal" class="modal fade">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.withdraw.data.reject') }}" method="POST" class="disableSubmission">
                    @csrf
                    <input type="hidden" name="id" value="{{ $withdrawal->id }}">
                    <div class="modal-body">
