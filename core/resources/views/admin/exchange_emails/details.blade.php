...
@section('panel')
    ...
    <!-- Header -->
    <div class="email-header" style="padding:1.5rem; border-bottom:1px solid #eee; background-color:#f9f9f9; display:flex; flex-direction:column;">
        <h2 style="margin:0 0 0.5rem 0; font-size:1.5rem; color:#333;">Subject: {{ $email->subject ?? '(No Subject)' }}</h2>
