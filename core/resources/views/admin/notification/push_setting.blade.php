...
@section('panel')
    ...
    <div class="modal fade" id="pushConfigJson">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="disableSubmission" method="POST" action="{{ route('admin.setting.notification.push.upload') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
