...
@section('panel')
    ...
    <div class="row @empty(!$sessionData) d-none @endempty">
        <div class="col-xl-12">
            <div class="card">
                <form class="notify-form disableSubmission" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control edit" style="display: none;" id="edit" name="message2" rows="10">{{ old('message', @$sessionData['message']) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        (function($) {
            ...
            $(".notify-form").on("submit", function(e) {
                ...
                if ($('.notification-via.active').data('method') === 'email') {
                    message = document.querySelector('.nicEdit-main').innerHTML;
                } else {
                    message = $('.edit')[0].value;
                }
