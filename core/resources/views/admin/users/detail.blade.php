        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6"
                        link="{{ route('admin.report.referral.commission') }}?search={{ $user->username }}" title="Balance"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.exchange.list', 'list') }}?user_id={{ $user->id }}"
                        title="Exchanges" icon="las la-wallet" value="{{ $totalExchange }}" bg="8" type="2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.ticket.index', $user->id) }}" title="Support Tickets"
                        icon="las la-exchange-alt" value="{{ $totalTicket }}" bg="17" type="2" />
                </div>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Commission Level')</label>
                                    <select name="commission_level" class="form-control select2">
                                        @foreach ($commission_levels as $commission_level)

                                            <option
                                                value="{{ $commission_level->level }}" @selected($user->commission_level == $commission_level->level)>
                                                {{ $commission_level->level }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                        <div class="flex-grow-1 position-relative">
                                            <input class="form-control" type="text" value="{{ @$user->fb_link }}" name="facebook_link"
                                                readonly>
                                            <a href="{{ @$user->fb_link }}" target="_blank"
                          ...
                          z-index: 10; text-indent: -9999px;">
                                        ...
                                        <div class="flex-shrink-0">
                                            <input type="checkbox" data-width="120" data-onstyle="-success"
                                                data-offstyle="-danger" data-bs-toggle="toggle"
                                                data-on="@lang('Verified')" data-off="@lang('Unverified')" name="is_fb_verify"
                                                @if ($user->is_fb_verify) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="form-group">
                                    <label>@lang('User Rate Change Permission')</label>
                                    <input type="checkbox" data-width="100%" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Enable')"
                                        data-off="@lang('Disable')" name="is_exchange_rate_permission"
                                        @if ($user->is_exchange_rate_permission) checked @endif>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success"
                                        ...
                                        @if ($user->neg_bal_allowed) checked @endif>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    <div id="userStatusModal" class="modal fade">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.users.status', $user->id) }}" method="POST" class="disableSubmission">
                    @csrf
