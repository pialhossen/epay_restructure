...
Route::post('paymentapi', 'Paymentapi\ProcessController@ipn')->name('paymentapi');
Route::post('/payment/webhook', 'Paymentapi\ProcessController@webhook')->name('payment.webhook');
Route::get('/payment/success', 'Paymentapi\ProcessController@success')->name('payment.success');
Route::get('/payment/cancel', 'Paymentapi\ProcessController@cancel')->name('payment.cancel');
