...
class Lists extends BaseModel
{
    ...
    protected $allowMethods = ['getList', 'create', 'get', 'update', 'delete', 'search', 'getContacts', 'updateContacts', 'deleteContacts'];
    ...
    public function updateContacts($id, $params = [])
    {
    ...
    public function deleteContacts($id, $params = [])
    {
