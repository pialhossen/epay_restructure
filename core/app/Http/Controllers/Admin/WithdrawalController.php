...
class WithdrawalController extends Controller
{
    ...
    public function approved($userId = null)
    {
        ...
        // $currency = Currency::enabled()->availableForSell()->where('id', $withdrawals->send_currency_id)->firstOrFail();
        // $currency->update(['reserve_amount' => $currency->reserve_amount - $withdrawals->sending_amount]);
        return view('admin.withdraw.withdrawals', compact('pageTitle', 'withdrawals'));
    }
