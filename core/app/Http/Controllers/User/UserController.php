...
class UserController extends Controller
{
    public function home()
    {
        ...
        $latestExchange = Exchange::where('user_id', $user->id)
            ->where('status', '!=', Status::EXCHANGE_INITIAL)
    ...
    public function commissionLog()
    {
        ...
        return view('Template::user.reports.commission_log', compact('pageTitle', 'logs'));
    }
}
