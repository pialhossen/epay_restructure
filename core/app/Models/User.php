...
class User extends Authenticatable
{
    ...
    public function scopeUserPermissionVerified($query)
    {
        return $query->where('is_exchange_rate_permission', Status::ENABLE);
    }

    public function scopeIsFBVerifyVerified($query)
    {
        return $query->where('is_fb_verify', Status::VERIFIED);
    }
